/*
  SNP Sensor temperature reading with RS485

  This example demonstrates how to use SNP_Sensor library to read temperature value from SNP Temperature sensor
