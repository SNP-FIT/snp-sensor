/*
  SNP Sensor illuminance reading with serial communication

  This example demonstrates how to use SNP_Sensor library to read illuminance value from SNP Light sensor
