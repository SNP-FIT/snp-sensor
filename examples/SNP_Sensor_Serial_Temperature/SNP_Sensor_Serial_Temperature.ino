/*
  SNP Sensor temperature reading with serial communication

  This example demonstrates how to use SNP_Sensor library to read temperature value from SNP Light sensor
